...
define('DOMAIN_URL', 'https://localhost/kaadmin/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_name = "kaadmin";    // Change as required
