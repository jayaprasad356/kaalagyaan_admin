...
if (isset($_POST['btnAdd'])) {
       ...
       if (!empty($city) && !empty($description) && !empty($category) && !empty($area_name) ) {
				...
				// upload new image
				$upload = move_uploaded_file($_FILES['product_image']['tmp_name'], 'upload/accordians/' . $menu_image);

				// insert new data to menu table
				$upload_image = 'upload/accordians/' . $menu_image;
            
            $sql_query = "INSERT INTO searchpage_accordians (city_id,category_id,description,area_name,image)VALUE('$city','$category','$description','$area_name','$upload_image')";
            $db->sql($sql_query);
            $result = $db->getResult();
            if (!empty($result)) {
                $result = 0;
            ...
            if ($result == 1) {
                ...
                $error['add_accordian'] = "<section class='content-header'>
                                                <span class='text text-success'>Accordians Added Successfully</span> </section>";
            } else {
                $error['add_accordian'] = " <span class='text text-danger'>Failed</span>";
            }
            }
        }
?>

    <?php echo isset($error['add_accordian']) ? $error['add_accordian'] : ''; ?>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="card">
								...
								<form name="add_accordian_form" method="post" enctype="multipart/form-data">
									<div class="card-body">
											<h3>Add Searchpage Accordian</h3>
											<section>
												<h6 class="h-0 m-0">&nbsp;</h6>
												<div class="row gutters">
													...
													<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
														...
														<div class="field-wrapper">
															<input type="text" placeholder="Enter Name" name="area_name" required>
